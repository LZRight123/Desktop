...
//💊👌🐒🐂👏🏿🌹⬆️㊙️🐱🎩🐂🐲✈️👀🚀🔥🎮💕🏆🎁 💯 🌹
#if true
# define LZLog(fmt, ...) NSLog((@"[文件名:%@]" "[函数名:%s]" "[行号:%d] --- " fmt), [[NSString stringWithUTF8String:__FILE__]componentsSeparatedByString:@"/"].lastObject, __FUNCTION__, __LINE__, ##__VA_ARGS__);
#else
# define LZLog(...);
#endif


@interface LZLogTool : NSObject
#define LZLogManager [LZLogTool manager]
...
#pragma mark -
#pragma mark - 常量
static NSString * bunlderID = @"com.imoney.AL.Carroll";
static NSString * myDylibName = @"TestImonDylib";

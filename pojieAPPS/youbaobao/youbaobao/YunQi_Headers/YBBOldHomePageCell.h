...
@class IMYSimpleCellModel, NSString, UIImageView, UILabel, YBBOldHomeSwitch;
@protocol YBBOldHomeCellActionPerformer;

@interface YBBOldHomePageCell : UITableViewCell <YBBOldHomeCell>
{
    id <YBBOldHomeCellActionPerformer> actionDelegate;
    UIImageView *_icon;
    UILabel *_nameLabel;
    UILabel *_infoLabel;
    YBBOldHomeSwitch *_switchBtn;
...
@property(retain, nonatomic) YBBOldHomeSwitch *switchBtn; // @synthesize switchBtn=_switchBtn;

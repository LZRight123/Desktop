...
@interface IMYRNExitLandscapeTransition : NSObject <UIViewControllerAnimatedTransitioning>
{
    UIView *_parentView;
    UIView *_targetView;
...
- (id)initWithTargetView:(id)arg1 originSuperView:(id)arg2 originFrame:(struct CGRect)arg3;

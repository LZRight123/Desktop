...
+ (id)animatedImageWithImages:(id)arg1 duration:(double)arg2 loopCount:(unsigned long long)arg3;
+ (id)animatedImageWithImages:(id)arg1 duration:(double)arg2;
+ (id)imy_animatedImageForKey:(id)arg1 usingCache:(_Bool)arg2;
+ (id)imy_animatedImageForKey:(id)arg1;

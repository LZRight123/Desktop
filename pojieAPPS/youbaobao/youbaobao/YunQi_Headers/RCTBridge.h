...
@class IMYRNView, NSArray, NSDictionary, NSLock, NSString, NSURL, RCTAccessibilityManager, RCTDevMenu, RCTDevSettings, RCTImageLoader, RCTImageStoreManager, RCTNetworking, RCTPerformanceLogger, RCTRedBox, RCTUIManager, UIViewController;
...
- (id)getRNViewWithViewID:(id)arg1;
- (id)getPageWithViewID:(id)arg1;
- (void)addRNView:(id)arg1 withViewID:(id)arg2;
@property(nonatomic) __weak IMYRNView *imy_rnview;
@property(nonatomic) __weak UIViewController *imy_vc;
@property(nonatomic) _Bool imy_used;

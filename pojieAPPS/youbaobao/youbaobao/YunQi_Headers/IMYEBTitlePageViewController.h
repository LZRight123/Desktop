...
@interface IMYEBTitlePageViewController : IMYEBBaseViewController <UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIScrollViewDelegate>
{
...
- (void).cxx_destruct;
- (void)scrollToViewController:(long long)arg1 withPath:(id)arg2;

...
@protocol YBBTodayTicDetailItem;

@interface YBBHomeTodayTicModel : NSObject <YBBHomeModel>
{
    _Bool _isDefault;
    _Bool _is_finish;
    _Bool _isPrefetched;
    ...
    NSArray<YBBTodayTicDetailItem> *_detail;
    long long _type;
}

+ (void)initialize;
@property(nonatomic) long long type; // @synthesize type=_type;
@property(retain, nonatomic) NSArray<YBBTodayTicDetailItem> *detail; // @synthesize detail=_detail;

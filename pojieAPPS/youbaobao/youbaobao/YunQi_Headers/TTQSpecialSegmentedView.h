...
@protocol TTQSpecialSegmentedViewDataSource, TTQSpecialSegmentedViewDelegate;

@interface TTQSpecialSegmentedView : UIView
{
    ...
    id <TTQSpecialSegmentedViewDelegate> _delegate;
    id <TTQSpecialSegmentedViewDataSource> _dataSource;
...
@property(nonatomic) __weak id <TTQSpecialSegmentedViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
@property(nonatomic) __weak id <TTQSpecialSegmentedViewDelegate> delegate; // @synthesize delegate=_delegate;

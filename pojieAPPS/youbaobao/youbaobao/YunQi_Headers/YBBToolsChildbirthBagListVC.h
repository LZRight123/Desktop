...
@class IMYCaptionView, NSString, UITableView, YBBToolsChildbirthBagListVM;

@interface YBBToolsChildbirthBagListVC : IMYPublicBaseViewController <UITableViewDataSource, UITableViewDelegate>
{
    CDUnknownBlockType _selectCallback;
    YBBToolsChildbirthBagListVM *_vm;
...
@property(retain, nonatomic) YBBToolsChildbirthBagListVM *vm; // @synthesize vm=_vm;

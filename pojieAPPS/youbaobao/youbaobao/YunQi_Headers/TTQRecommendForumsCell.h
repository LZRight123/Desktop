...
@interface TTQRecommendForumsCell : TTQTableViewCell
{
    NSMutableArray *_forumBtns;
}

@property(retain, nonatomic) NSMutableArray *forumBtns; // @synthesize forumBtns=_forumBtns;
- (void).cxx_destruct;

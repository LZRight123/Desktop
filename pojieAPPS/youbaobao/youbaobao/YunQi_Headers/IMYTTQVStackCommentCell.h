...
@class IMYRM80AttributedLabel, IMYTouchEXButton, NSString, UIImageView, UIView;

@interface IMYTTQVStackCommentCell : IMYTableViewCell <IMYRM80AttributedLabelDelegate>
{
    ...
    UIView *_headerView;
    UIView *_footerView;
    IMYTouchEXButton *_moreReplyButton;
...
@property(retain, nonatomic) IMYTouchEXButton *moreReplyButton; // @synthesize moreReplyButton=_moreReplyButton;

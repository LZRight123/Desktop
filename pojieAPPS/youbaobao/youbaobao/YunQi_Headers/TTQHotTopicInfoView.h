...
@class IMYActionTab, IMYRM80AttributedLabel, NSString, UIImageView, UILabel, UIVisualEffectView;

@interface TTQHotTopicInfoView : UIView <IMYRM80AttributedLabelDelegate, TTQHotTopicInfoViewProtocol>
{
...
- (void)setupCardView:(id)arg1 cardAction:(CDUnknownBlockType)arg2;

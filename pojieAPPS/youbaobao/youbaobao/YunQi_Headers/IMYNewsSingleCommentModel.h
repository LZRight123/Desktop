...
@class IMYNewsCommentNewsDetailModel, IMYNewsPublisherModel, NSArray, NSString;

@interface IMYNewsSingleCommentModel : NSObject
{
    _Bool _is_deleted;
    _Bool _is_author;
    _Bool _is_praise;
    ...
    IMYNewsCommentNewsDetailModel *_news_detail;
    IMYNewsPublisherModel *_publisher;
    IMYNewsSingleCommentModel *_reference;
    NSArray *_sub_review;
}
...
@property(retain, nonatomic) IMYNewsSingleCommentModel *reference; // @synthesize reference=_reference;
@property(retain, nonatomic) IMYNewsPublisherModel *publisher; // @synthesize publisher=_publisher;
@property(retain, nonatomic) IMYNewsCommentNewsDetailModel *news_detail; // @synthesize news_detail=_news_detail;

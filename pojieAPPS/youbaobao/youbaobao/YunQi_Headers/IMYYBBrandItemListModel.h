...
@protocol IMYYBBrandItemModel;

@interface IMYYBBrandItemListModel : NSObject
{
    _Bool _isSorted;
    ...
    NSArray<IMYYBBrandItemModel> *_item_list;
}

@property(retain, nonatomic) NSArray<IMYYBBrandItemModel> *item_list; // @synthesize item_list=_item_list;

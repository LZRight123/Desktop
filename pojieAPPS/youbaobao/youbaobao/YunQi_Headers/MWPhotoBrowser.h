...
@class MBProgressHUD, MPMoviePlayerViewController, MWGridViewController, NSArray, NSMutableArray, NSMutableSet, NSString, NSTimer, UIActivityIndicatorView, UIActivityViewController, UIBarButtonItem, UIButton, UIColor, UIImage, UIImageView, UIScrollView, UIToolbar;
@protocol IMYToolsPhotoBrowserProtocol, MWPhotoBrowserDelegate;
...
@interface MWPhotoBrowser : UIViewController <UIScrollViewDelegate, UIActionSheetDelegate>
{
    ...
    long long _updateStatusBarAnimationStyle;
    _Bool _hasLayouted;
    ...
    id <IMYToolsPhotoBrowserProtocol> _toolsDelegate;
...
@property(nonatomic) _Bool customVideoPlayAction; // @synthesize customVideoPlayAction=_customVideoPlayAction;
@property(nonatomic) unsigned long long appType; // @synthesize appType=_appType;
@property(nonatomic) __weak id <IMYToolsPhotoBrowserProtocol> toolsDelegate; // @synthesize toolsDelegate=_toolsDelegate;
...
- (void).cxx_destruct;
@property(readonly, nonatomic) UIButton *currentPlayBtn;
@property(readonly, nonatomic) UIImageView *currentImgView;
@property(readonly, nonatomic) UIScrollView *currentPage;
...
- (void)playVideoWithTapButtonIndex:(unsigned long long)arg1;

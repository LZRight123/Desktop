...
@interface TTQFeedRefreshCell : TTQTableViewCell
{
    UILabel *_refreshLable;
}

@property(retain, nonatomic) UILabel *refreshLable; // @synthesize refreshLable=_refreshLable;
- (void).cxx_destruct;

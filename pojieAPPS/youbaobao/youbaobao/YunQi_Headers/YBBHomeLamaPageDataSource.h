...
#import "YBBSegmentedControlDataSource-Protocol.h"

@class NSArray, NSMutableDictionary, NSMutableSet, NSString, YBBHomeLamaBabyModel;

@interface YBBHomeLamaPageDataSource : NSObject <YBBHomePageDataSourceProtocol, YBBSegmentedControlDataSource>
{
    ...
    NSArray *_oldArray;
    YBBHomeLamaBabyModel *_headerDefaultData;
...
@property(retain, nonatomic) YBBHomeLamaBabyModel *headerDefaultData; // @synthesize headerDefaultData=_headerDefaultData;

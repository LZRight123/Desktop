...
#import "IMYTTQVDetailViewProtocol-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class IMYCaptionView, IMYSimpleTableView, IMYTTQVCommentViewModel, NSString, UIScrollView;
@protocol IMYITableViewAdManager, IMYTTQVContentDetailViewDelegate;

@interface IMYTTQVCommentVC : IMYTTQVCommentBaseVC <UITableViewDelegate, IMYTTQVDetailViewProtocol>
{
    ...
    id <IMYTTQVContentDetailViewDelegate> _imyDelegate;
    long long _newsId;
    long long _type;
    long long _position;
...
@property(nonatomic) __weak id <IMYTTQVContentDetailViewDelegate> imyDelegate; // @synthesize imyDelegate=_imyDelegate;
- (void).cxx_destruct;

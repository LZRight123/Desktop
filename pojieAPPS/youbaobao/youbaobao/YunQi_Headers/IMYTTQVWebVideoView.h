...
#import "IMYTTQVCommonWebPlayerDelegate-Protocol.h"
#import "IMYVForeViewDelegate-Protocol.h"
#import "IMYVKWebViewDelegate-Protocol.h"

@class CommonVLoadingView, HLRetryView, IMYTTQCommonWebPlayer, IMYTTQCommonWebPlayerFullScreenVC, IMYVForeView, IMYVideoModel, IMYVideoOptions, NSString;
@protocol IMYTTQVWebVideoViewDelegate;

@interface IMYTTQVWebVideoView : UIView <IMYTTQVCommonWebPlayerDelegate, IMYVKWebViewDelegate, IMYVForeViewDelegate>
{
    _Bool _isWebStarting;
    id <IMYTTQVWebVideoViewDelegate> _delegate;
    ...
    NSString *_al_source;
    NSString *_algorithm;
    IMYTTQCommonWebPlayer *_player;
    NSString *_pausedReason;
    CommonVLoadingView *_loadingView;
    HLRetryView *_retryView;
    IMYTTQCommonWebPlayerFullScreenVC *_fullScreenVC;
}
...
@property(retain, nonatomic) IMYTTQCommonWebPlayerFullScreenVC *fullScreenVC; // @synthesize fullScreenVC=_fullScreenVC;
...
@property(retain, nonatomic) IMYTTQCommonWebPlayer *player; // @synthesize player=_player;
...
@property(nonatomic) __weak id <IMYTTQVWebVideoViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;

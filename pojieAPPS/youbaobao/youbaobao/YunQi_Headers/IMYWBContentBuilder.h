...
@interface IMYWBContentBuilder : NSObject <IMYIContentBuilder>
{
}

+ (void)getResultImageWithContent:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
+ (id)preBuildWithContent:(id)arg1;

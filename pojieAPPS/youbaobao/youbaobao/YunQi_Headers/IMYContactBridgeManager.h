...
@interface IMYContactBridgeManager : NSObject <ABPeoplePickerNavigationControllerDelegate, CNContactPickerDelegate>
{
    CDUnknownBlockType _callback;
}

+ (id)shareContactBridgeManager;
...
- (void)openContact;
- (void)checkCNContactAuthrization;
- (void)checkABContactAuthrization;
- (void)showAlertView;
- (void)checkContactAuthrizationStatus;
- (void)contactWithCallBack:(CDUnknownBlockType)arg1;

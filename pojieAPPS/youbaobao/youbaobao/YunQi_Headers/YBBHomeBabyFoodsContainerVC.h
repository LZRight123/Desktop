...
@interface YBBHomeBabyFoodsContainerVC : IMYPublicBaseViewController <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UICollectionViewDelegate, UICollectionViewDataSource, IMYVKWebViewControllerDelegate>
{
    _Bool _hasMore;

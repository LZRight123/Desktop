...
@class IMYAvatarImageView, IMYButton, IMYLineView, IMYRM80AttributedLabel, IMYTTQVCommentReferenceView, IMYTTQVPraiseView, NSString, UIButton, UIImageView, UILabel, UIView;

@interface IMYTTQVCommentCell : IMYTableViewCell <IMYRM80AttributedLabelDelegate>
{
    ...
    IMYTTQVCommentReferenceView *_referenceView;
...
@property(retain, nonatomic) IMYTTQVCommentReferenceView *referenceView; // @synthesize referenceView=_referenceView;

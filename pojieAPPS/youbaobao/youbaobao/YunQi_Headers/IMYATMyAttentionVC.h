...
@class IMYATDynamicRefreshView, IMYATTopToastView, IMYAvatarImageView, IMYCaptionView, NSMutableArray, NSString, UIImageView, UILabel, UITableView, UIView;

@interface IMYATMyAttentionVC : IMYPublicBaseViewController <UITableViewDataSource, UITableViewDelegate>
{
    UIView *_bannerView;
...
@property(retain, nonatomic) IMYATTopToastView *toastView; // @synthesize toastView=_toastView;

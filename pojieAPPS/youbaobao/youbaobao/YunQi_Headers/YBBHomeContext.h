...
@class NSDictionary, NSString, UITableView, UIViewController, YBBHomeGroupItem;

@interface YBBHomeContext : NSObject
{
    long long _pageIndex;
    long long _todayIndex;
    long long _week;
    long long _userMode;
    YBBHomeGroupItem *_groupItem;
    NSString *_source;
...
@property(retain, nonatomic) YBBHomeGroupItem *groupItem; // @synthesize groupItem=_groupItem;

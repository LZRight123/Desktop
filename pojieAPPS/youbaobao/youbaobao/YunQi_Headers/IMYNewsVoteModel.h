...
@protocol IMYNewsVoteItemModel;

@interface IMYNewsVoteModel : NSObject <YYJSONHelperProtocol>
{
    ...
    double _over_time;
    NSArray<IMYNewsVoteItemModel> *_items;
}

+ (void)initialize;
@property(retain, nonatomic) NSArray<IMYNewsVoteItemModel> *items; // @synthesize items=_items;

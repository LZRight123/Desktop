...
@class NSArray, NSMutableDictionary, NSString, UIPageViewController, UIView, YBBOldBabyGrowDataSource, YBBTipsSegmentedControl;

@interface YBBOldBabyGrowVC : IMYPublicBaseViewController <UIPageViewControllerDelegate, UIScrollViewDelegate>
{
    _Bool _isLocked;
    YBBOldBabyGrowDataSource *_babyDataSource;
...
@property(readonly, nonatomic) YBBOldBabyGrowDataSource *babyDataSource; // @synthesize babyDataSource=_babyDataSource;
- (void).cxx_destruct;
- (void)shareBabyInfo;

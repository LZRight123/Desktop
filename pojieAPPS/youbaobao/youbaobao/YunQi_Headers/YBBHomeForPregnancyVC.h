...
@class NSArray, NSString, YBBHomeForPregnancyHeaderModel;
@protocol IMYITableViewAdManager;

@interface YBBHomeForPregnancyVC : YBBHomeBaseVC <UITableViewDataSource, UITableViewDelegate, YBBHomeCellActionPerformer>
{
    NSArray *_dataList;
    YBBHomeForPregnancyHeaderModel *_headerData;
...
@property(retain, nonatomic) YBBHomeForPregnancyHeaderModel *headerData; // @synthesize headerData=_headerData;

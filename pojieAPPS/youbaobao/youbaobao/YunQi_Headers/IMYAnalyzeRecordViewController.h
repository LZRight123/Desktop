...
@interface IMYAnalyzeRecordViewController : IMYPublicBaseViewController <UITableViewDelegate, UITableViewDataSource>
{
...
+ (id)viewControllerWithRecords:(id)arg1 type:(long long)arg2;

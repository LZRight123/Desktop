...
@class IMYCaptionView, NSMutableArray, NSString, UITableView, YBBOldGlobalSearchTopView;

@interface YBBOldGlobalSearchForumVC : YBBHomeHideNavigationViewController <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
{
    _Bool _didChanged;
    NSString *_keyword;
    NSString *_searchKey;

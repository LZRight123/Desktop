...
@class IMYTTQVSingleCommentModel, NSString;

@interface IMYTTQVCommentCellModel : IMYCellModel
{
    _Bool _is_praise;
    ...
    IMYTTQVSingleCommentModel *_singleCommentModel;
...
@property(retain, nonatomic) IMYTTQVSingleCommentModel *singleCommentModel; // @synthesize singleCommentModel=_singleCommentModel;

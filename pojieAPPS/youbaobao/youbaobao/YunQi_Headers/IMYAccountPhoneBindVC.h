...
@interface IMYAccountPhoneBindVC : IMYAccountBaseVC <UITableViewDelegate, UITableViewDataSource>
{
    _Bool _hasSkip;
    long long _bindType;
...
- (void).cxx_destruct;
- (void)handleOneKeyLogin;
- (id)createByCodeVC:(long long)arg1;

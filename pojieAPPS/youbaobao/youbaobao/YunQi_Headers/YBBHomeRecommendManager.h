...
@class NSArray, RACSignal, YBBHomeRecommendInterItem;

@interface YBBHomeRecommendManager : NSObject
{
    RACSignal *_refreshSignal;
    RACSignal *_moreDataSignal;
    long long _timestamp;
    YBBHomeRecommendInterItem *_interItem;
    NSArray *_dataArray;
    long long _userMode;
}
...
@property(retain, nonatomic) YBBHomeRecommendInterItem *interItem; // @synthesize interItem=_interItem;

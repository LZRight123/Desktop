...
@class NSArray, NSAttributedString, NSString, YBBHomeRecommendLayout;

@interface YBBHomeRecommendModel : NSObject <YBBHomeModel>
{
    _Bool _is_anonymous;
    _Bool _hasRead;
    long long _topicId;
    ...
    NSString *_img;
    YBBHomeRecommendLayout *_cellLayout;
}

+ (void)initialize;
@property(retain, nonatomic) YBBHomeRecommendLayout *cellLayout; // @synthesize cellLayout=_cellLayout;

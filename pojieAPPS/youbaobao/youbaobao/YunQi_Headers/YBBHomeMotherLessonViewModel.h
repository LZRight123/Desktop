...
@class NSArray, NSString, YBBHomeMotherLessonModel, YBBHomeMotherLessonTextItem;

@interface YBBHomeMotherLessonViewModel : NSObject
{
    _Bool _archive;
    _Bool _like;
    _Bool _needMoreBtn;
    ...
    NSArray *_dataArray;
    YBBHomeMotherLessonTextItem *_textItem;
}

@property(retain, nonatomic) YBBHomeMotherLessonTextItem *textItem; // @synthesize textItem=_textItem;

...
#import "IMYTTQVTagCollectionViewDataSource-Protocol.h"
#import "IMYTTQVTagCollectionViewDelegate-Protocol.h"

@class IMYTTQTagCollectionView, IMYTTQTextTagConfig, NSMutableArray, NSString, UIScrollView;
@protocol IMYTTQVTextTagCollectionViewDelegate;

@interface IMYTTQVTextTagCollectionView : UIView <IMYTTQVTagCollectionViewDataSource, IMYTTQVTagCollectionViewDelegate>
{
    _Bool _enableTagSelection;
    id <IMYTTQVTextTagCollectionViewDelegate> _delegate;
    IMYTTQTextTagConfig *_defaultConfig;
    unsigned long long _selectionLimit;
    NSMutableArray *_tagLabels;
    IMYTTQTagCollectionView *_tagCollectionView;
...
@property(retain, nonatomic) IMYTTQTagCollectionView *tagCollectionView; // @synthesize tagCollectionView=_tagCollectionView;
...
@property(retain, nonatomic) IMYTTQTextTagConfig *defaultConfig; // @synthesize defaultConfig=_defaultConfig;
@property(nonatomic) _Bool enableTagSelection; // @synthesize enableTagSelection=_enableTagSelection;
@property(nonatomic) __weak id <IMYTTQVTextTagCollectionViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;

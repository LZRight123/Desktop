...
@class IMYCaptionView, NSArray, NSMutableArray, NSMutableSet, NSString, UITableView, UIView, YBBOldKnowledgePageNavView, YBBOldKnowledgePageVM;
@protocol IMYITableViewAdManager;

@interface YBBOldKnowledgePageVC : IMYPublicBaseViewController <UITableViewDelegate, UITableViewDataSource>
{
    _Bool _didRequestToken;
    _Bool _haveRequestAD;
    CDUnknownBlockType _scrollViewDidScrollBlock;
    UITableView *_mainTableView;
    YBBOldKnowledgePageVM *_vm;
    id <IMYITableViewAdManager> _adManager;
    CDUnknownBlockType _stopVidwoBlock;
    IMYCaptionView *_captionView;
    UIView *_toolsView;
    UIView *_hotWordsView;
    YBBOldKnowledgePageNavView *_navView;
...
@property(retain, nonatomic) YBBOldKnowledgePageNavView *navView; // @synthesize navView=_navView;
...
@property(retain, nonatomic) YBBOldKnowledgePageVM *vm; // @synthesize vm=_vm;

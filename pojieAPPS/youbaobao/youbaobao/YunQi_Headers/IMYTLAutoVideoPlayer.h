...
@class IMYTLAutoPlayModel, IMYVideoModel, IMYVideoView, NSString, NSTimer, PHAsset;
@protocol IMYTLAutoVideoPlayerDelegate;

@interface IMYTLAutoVideoPlayer : IMYTLView <IMYVideoViewDelegate>
{
    _Bool _turnOnTimeoutHandle;
    _Bool _repeatPlay;
    _Bool _autoBackgroundControl;
    _Bool _lastPauseIsTriggerByResignActive;
    _Bool _isPlaying;
    IMYTLAutoPlayModel *_timeline;
    id <IMYTLAutoVideoPlayerDelegate> _delegate;
...
@property(nonatomic) _Bool autoBackgroundControl; // @synthesize autoBackgroundControl=_autoBackgroundControl;
@property(nonatomic) _Bool repeatPlay; // @synthesize repeatPlay=_repeatPlay;
@property(nonatomic) _Bool turnOnTimeoutHandle; // @synthesize turnOnTimeoutHandle=_turnOnTimeoutHandle;
@property(nonatomic) __weak id <IMYTLAutoVideoPlayerDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) IMYTLAutoPlayModel *timeline; // @synthesize timeline=_timeline;
- (void).cxx_destruct;
- (void)dealloc;

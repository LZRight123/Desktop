...
@protocol YBBHomeGlobalSearchForumModel;

@interface YBBGlobalSearchModel : NSObject
{
    _Bool _more;
    NSString *_keyword;
    NSString *_type;
    unsigned long long _searchType;
    NSArray<YBBHomeGlobalSearchForumModel> *_items;
    NSString *_more_url;
}
...
@property(retain, nonatomic) NSArray<YBBHomeGlobalSearchForumModel> *items; // @synthesize items=_items;

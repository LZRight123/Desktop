...
@class IMYATAvatarModel, IMYATUserThumbDynamicModel, NSArray, NSString;
@protocol IMYATUserTitle;

@interface IMYATUserIntroduceModel : NSObject
{
    int _fuid;
    int _is_married;
    int _isfollow;
    ...
    IMYATUserThumbDynamicModel *_content;
    NSArray<IMYATUserTitle> *_forumtitle;
    IMYATUserThumbDynamicModel *_topics;
    IMYATAvatarModel *_avatars;
    NSString *_reason;
    NSString *_comefrom;
...
@property(retain, nonatomic) IMYATAvatarModel *avatars; // @synthesize avatars=_avatars;
@property(retain, nonatomic) IMYATUserThumbDynamicModel *topics; // @synthesize topics=_topics;
@property(nonatomic) int isfollow; // @synthesize isfollow=_isfollow;
@property(retain, nonatomic) NSArray<IMYATUserTitle> *forumtitle; // @synthesize forumtitle=_forumtitle;
@property(retain, nonatomic) IMYATUserThumbDynamicModel *content; // @synthesize content=_content;

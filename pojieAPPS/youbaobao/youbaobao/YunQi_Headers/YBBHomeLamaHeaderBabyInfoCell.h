...
@class CALayer, NSArray, UILabel, YBBHomeLamaHeaderPageModel;

@interface YBBHomeLamaHeaderBabyInfoCell : UICollectionViewCell
{
    _Bool _showGradinet;
    _Bool _isWhiteColor;
    UILabel *_timeLabel;
    ...
    YBBHomeLamaHeaderPageModel *_model;
...
@property(retain, nonatomic) YBBHomeLamaHeaderPageModel *model; // @synthesize model=_model;

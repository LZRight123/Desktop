...
struct hook_t hook_list[] = {// system 没替换
    ...
    {CFNetworkCopySystemProxySettings, "/System/Library/Frameworks/CFNetwork.framework/CFNetwork", "func_CFNetworkCopySystemProxySettings"}, //1
    //反反调试
    ...
    {fopen, "/usr/lib/system/libsystem_c.dylib", "fopen"}, //12
...
static CFArrayRef my_CNCopySupportedInterfaces(){
    CFArrayRef r = orig_CNCopySupportedInterfaces();
//    NSArray *ifs = (__bridge_transfer id)r;
...
//        }
//    }
//    [CCLogManager addLog:@"[文件名:CC_CFunction.m][类名:反反代理][方法名:my_CNCopySupportedInterfaces]检测了代理"];
    return r;
}
...
__attribute__((constructor)) static void entry(){
    ...
    if (openAntiAntiNetworkProxy) {
        ...
        rebind_symbols((struct rebinding[1]){{"CNCopySupportedInterfaces", my_CNCopySupportedInterfaces, (void*)&orig_CNCopySupportedInterfaces}}, 1);
    }

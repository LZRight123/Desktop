...
@protocol NTESPageViewDataSource, NTESPageViewDelegate;
...
@interface NTESPageView : UIView <UIScrollViewDelegate>
{
    ...
    id <NTESPageViewDataSource> _dataSource;
    id <NTESPageViewDelegate> _pageViewDelegate;
    NSMutableArray *_pages;
}

@property(retain, nonatomic) NSMutableArray *pages; // @synthesize pages=_pages;
@property(nonatomic) __weak id <NTESPageViewDelegate> pageViewDelegate; // @synthesize pageViewDelegate=_pageViewDelegate;
@property(nonatomic) __weak id <NTESPageViewDataSource> dataSource; // @synthesize dataSource=_dataSource;

...
@protocol NIMPageViewDataSource, NIMPageViewDelegate;
...
@interface NIMPageView : UIView <UIScrollViewDelegate>
{
    ...
    id <NIMPageViewDataSource> _dataSource;
    id <NIMPageViewDelegate> _pageViewDelegate;
    NSMutableArray *_pages;
}

@property(retain, nonatomic) NSMutableArray *pages; // @synthesize pages=_pages;
@property(nonatomic) __weak id <NIMPageViewDelegate> pageViewDelegate; // @synthesize pageViewDelegate=_pageViewDelegate;
@property(nonatomic) __weak id <NIMPageViewDataSource> dataSource; // @synthesize dataSource=_dataSource;

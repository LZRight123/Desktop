...
@class SearchFriendsListModel, UIImageView, UILabel;

@interface SearchFriendsCell : UITableViewCell
{
    SearchFriendsListModel *_model;
...
@property(retain, nonatomic) SearchFriendsListModel *model; // @synthesize model=_model;
- (void).cxx_destruct;
- (void)setUI;

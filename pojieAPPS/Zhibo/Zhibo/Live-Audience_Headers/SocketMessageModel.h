...
@property(copy, nonatomic) NSString *win_money; // @synthesize win_money=_win_money;
...
@property(copy, nonatomic) NSString *to_client_id; // @synthesize to_client_id=_to_client_id;

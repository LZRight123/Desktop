...
@class AttentionModel, UIImageView, UILabel;

@interface ZPFansTableViewCell : UITableViewCell
{
...
@property(retain, nonatomic) AttentionModel *model; // @synthesize model=_model;
- (void).cxx_destruct;
- (void)layoutSubviews;
- (void)setUI;

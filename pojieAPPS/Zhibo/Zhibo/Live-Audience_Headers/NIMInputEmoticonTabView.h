...
@protocol NIMInputEmoticonTabDelegate;

@interface NIMInputEmoticonTabView : UIControl
{
    UIButton *_sendButton;
    id <NIMInputEmoticonTabDelegate> _delegate;
...
@property(nonatomic) __weak id <NIMInputEmoticonTabDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) UIButton *sendButton; // @synthesize sendButton=_sendButton;
- (void).cxx_destruct;
- (void)layoutSubviews;
- (void)selectTabIndex:(long long)arg1;
- (void)onTouchTab:(id)arg1;
- (void)loadCatalogs:(id)arg1;

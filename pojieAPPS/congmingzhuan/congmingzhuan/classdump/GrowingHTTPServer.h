...
@class GrowingGCDAsyncSocket, NSDictionary, NSLock, NSMutableArray, NSNetService, NSString;
@protocol OS_dispatch_queue;

@interface GrowingHTTPServer : NSObject <NSNetServiceDelegate>
{
...
- (void).cxx_destruct;
- (void)GrowingWebSocketServerDidDie:(id)arg1;
...
- (id)config;
- (unsigned long long)numberOfGrowingWebSocketServerConnections;
- (unsigned long long)numberOfGrowingHTTPConnections;
- (void)addGrowingWebSocketServer:(id)arg1;
- (_Bool)isRunning;

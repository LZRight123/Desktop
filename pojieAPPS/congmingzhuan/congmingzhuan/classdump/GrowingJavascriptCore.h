...
@interface GrowingJavascriptCore : NSObject <GrowingNodeAsyncNativeHandler>
{
    ...
    id <WebScoketDelegate> _webScoketDelegate;
...
@property(retain, nonatomic) id <WebScoketDelegate> webScoketDelegate; // @synthesize webScoketDelegate=_webScoketDelegate;
...
- (id)parseNode:(id)arg1 global_isTrackingEditText:(_Bool)arg2;
...
- (_Bool)parseJointField:(id)arg1 toFieldA:(id)arg2 toFieldB:(id)arg3;
- (id)joinXPath:(id)arg1 hybridXPaths:(id)arg2;
- (id)jointField:(id)arg1 withField:(id)arg2;
...
- (void)handleVisitorEventCallback:(id)arg1;
- (void)handleClearUserIDEventCallback:(id)arg1;
- (void)handleSetUserIDEventCallback:(id)arg1;
- (void)handlePeopleVarEventCallback:(id)arg1;
- (void)handleEVarEventCallback:(id)arg1;
- (void)handlePageVarEventCallback:(id)arg1;
- (void)handleCustomEventCallback:(id)arg1;
- (void)handleSubmitCallback:(id)arg1;
- (void)handleChangeCallback:(id)arg1;
...
- (id)hybridJSSDKCircleScriptWeb;
- (id)hybridJSSDKCircleScript;
- (id)hybridJSSDKScript;
- (id)configHybridNativeInfo;

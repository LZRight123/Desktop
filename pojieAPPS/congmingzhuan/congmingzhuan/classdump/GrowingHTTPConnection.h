...
@class GrowingGCDAsyncSocket, GrowingHTTPConfig, GrowingHTTPMessage, NSMutableArray, NSString;
@protocol GrowingHTTPResponse, OS_dispatch_queue;
...
- (id)webSocketServerForURI:(id)arg1;
- (id)GrowingHTTPResponseForMethod:(id)arg1 URI:(id)arg2;

...
@interface MOBFBaseService : NSObject <MOBFLogServiceDelegate>
{
    ...
    NSObject<OS_dispatch_queue> *_gmsQueue;
}
...
+ (void)setDomainPrefix:(id)arg1;
+ (id)sharedInstance;
+ (void)initialize;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *gmsQueue; // @synthesize gmsQueue=_gmsQueue;
...
- (void).cxx_destruct;
- (id)getReuqestProtocolAndDomain;
...
- (void)_getGmWifiInfoWithInfos:(id)arg1 bssid:(id)arg2 wifiLevel:(int)arg3;
- (void)_getGmWifiInfo;
- (void)_setupGmHeadingService;
- (void)_setupGmAcService;
- (void)_setupGmGyroService;
- (void)_setupGmGsService;
- (void)handleGmDatas:(id)arg1 type:(long long)arg2;
- (void)_setupGmDatasService:(_Bool)arg1;
...
- (void)_getAccelerationData:(_Bool)arg1;
...
- (void)_getWifiInfoWithInfos:(id)arg1 bssid:(id)arg2 wifiLevel:(int)arg3;

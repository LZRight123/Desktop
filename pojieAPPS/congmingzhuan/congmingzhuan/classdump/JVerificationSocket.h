...
@class JVerificationReadPacket, JVerificationSocketPreBuffer, JVerificationWritePacket, NSData, NSMutableArray, NSString, NSURL;
@protocol JVerificationSocketDelegate, OS_dispatch_queue, OS_dispatch_source;

@interface JVerificationSocket : NSObject
{
    unsigned int flags;
    unsigned short config;
    id <JVerificationSocketDelegate> delegate;
    ...
    JVerificationReadPacket *currentRead;
    JVerificationWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    JVerificationSocketPreBuffer *preBuffer;
    CDStruct_4210025a streamContext;
    struct __CFReadStream *readStream;
    struct __CFWriteStream *writeStream;
    struct SSLContext *sslContext;
    JVerificationSocketPreBuffer *sslPreBuffer;
...
- (id)getDataAddressByHost:(id)arg1 port:(unsigned short)arg2;
...
@property __weak id <JVerificationSocketDelegate> delegate;

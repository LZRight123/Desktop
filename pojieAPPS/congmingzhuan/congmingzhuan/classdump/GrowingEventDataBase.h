...
@property(readonly, copy, nonatomic) NSString *sqliteName; // @synthesize sqliteName=_sqliteName;
...
- (id)vacuum;
- (id)flush;
- (id)flush_deleteDataBaseV2:(id)arg1 byKeys:(id)arg2;
- (id)flush_deleteDataBase:(id)arg1 byKeys:(id)arg2;
- (id)flush_insertDataBaseV2:(id)arg1 byKeys:(id)arg2 values:(id)arg3;

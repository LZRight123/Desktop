...
@class NSData, NSMutableArray, NSString, NSURL, XGGCDAsyncReadPacket, XGGCDAsyncSocketPreBuffer, XGGCDAsyncWritePacket;
@protocol OS_dispatch_queue, OS_dispatch_source, XGGCDAsyncSocketDelegate;

@interface XGGCDAsyncSocket : NSObject
{
    unsigned int flags;
    unsigned short config;
    id <XGGCDAsyncSocketDelegate> delegate;
    ...
    XGGCDAsyncReadPacket *currentRead;
    XGGCDAsyncWritePacket *currentWrite;
    unsigned long long socketFDBytesAvailable;
    XGGCDAsyncSocketPreBuffer *preBuffer;

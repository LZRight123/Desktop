...
@class NSDictionary, NSMutableDictionary, NSObject, NSString, UAAPIManager, UACustomModel, UAReachability, UASDKServerConfig, UIButton, UILabel, UITextField, UIView;

#line 1 "/Users/liangze/Documents/Desktop/pojieAPPS/congmingzhuan/congmingzhuanDylib/CCTweakTool/CC_Object-C.xm"
...
static void _logos_method$_ungrouped$NSMutableURLRequest$setHTTPBody$(_LOGOS_SELF_TYPE_NORMAL NSMutableURLRequest* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, NSData * data){
    ...
    if ([self.URL.absoluteString containsString:@"https://front.congmingzhuan.com/front/ios/task/getAvailableTaskList"]){
        NSLog(@"xx");
    }
...
static void _logos_method$_ungrouped$NSMutableURLRequest$setValue$forHTTPHeaderField$(_LOGOS_SELF_TYPE_NORMAL NSMutableURLRequest* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, NSString * value, NSString * field){
    if ([field isEqualToString:@"sessionid"]) {
        NSLog(@"");
        HBLogDebug(@"-[<NSMutableURLRequest: %p> setValue:%@ forHTTPHeaderField:%@]", self, value, field);
    }
    _logos_orig$_ungrouped$NSMutableURLRequest$setValue$forHTTPHeaderField$(self, _cmd, value, field);
}
...
static void _logos_method$_ungrouped$NSMutableURLRequest$addValue$forHTTPHeaderField$(_LOGOS_SELF_TYPE_NORMAL NSMutableURLRequest* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, NSString * value, NSString * field){
    HBLogDebug(@"-[<NSMutableURLRequest: %p> addValue:%@ forHTTPHeaderField:%@]", self, value, field);
    _logos_orig$_ungrouped$NSMutableURLRequest$addValue$forHTTPHeaderField$(self, _cmd, value, field);
}
...
static NSURL * _logos_method$_ungrouped$NSMutableURLRequest$URL(_LOGOS_SELF_TYPE_NORMAL NSMutableURLRequest* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd){
    ...
    if ([url.absoluteString containsString:@"https://front.congmingzhuan.com/front/ios/task/getAvailableTaskList"]){
        NSLog(@"xx");
    }

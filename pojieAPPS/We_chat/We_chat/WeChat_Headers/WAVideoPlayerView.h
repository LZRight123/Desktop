...
@class AVPlayerItemVideoOutput, MMUIButton, MMUIImageView, MMUILabel, NSString, NSURLConnection, UIImage, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer, UITopTouchView, WAPlayerHttpMediaWrap, WAScreenBrightnessStateView, WAVideoLayer, WCNetworkMediaSlider, WCPlayerInfo, WCPlayerView;
@protocol WAVideoPlayerViewDelegate, WCPlayerControlViewDelegate;

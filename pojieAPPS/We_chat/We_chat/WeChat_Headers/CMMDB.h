...
- (optional_34114161)shouldCreateTable:(id)arg1 inDatabase:(id)arg2;
- (optional_34114161)lazyCreateMessageTable:(id)arg1;
- (int)indexOfDatabaseForTableName:(id)arg1;
- (int)indexOfDatabaseForUserName:(id)arg1;
- (int)indexOfDatabaseForMD5UserName:(id)arg1;
- (optional_34114161)lazyCreateBrandTable:(id)arg1;

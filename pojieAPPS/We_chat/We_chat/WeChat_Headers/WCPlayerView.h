...
@interface WCPlayerView : UIView <WCPlayerResourceLoaderDelegate, IVOIPWindowExt, WCAudioSessionExt, WCPlayerControlViewDelegate>
{
...
- (void)getCurrentVideoImageAsyncWithCompletionHanlder:(CDUnknownBlockType)arg1;
- (id)getCurrentVideoImage;

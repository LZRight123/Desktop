...
@class FTSWebSearchMgr, MMTagSearchBar, MMUIViewController, NSMutableArray, NSMutableDictionary, NSString, UIImageView, UISearchBar, UITextField, UIView, WASearchFromGlobalProxy, WSContactSearchLogic, WSEmoticonPadViewController, WSHistoryCacheLogic, WSJSEventHandler, WSResultViewLogic, WSTagSearchLogic;

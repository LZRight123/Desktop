...
@class CLLocation, LocationRetriever, NSDictionary, NSObject, NSString, WCCardBulkImportMgr, WCCardLayoutMgr, WCCardMsgCenterMgr, WCCardPkgBatchDelMgr, WCCardPkgBatchGetCardItemByTpInfoMgr, WCCardPkgBatchGetMgr, WCCardPkgDB, WCCardPkgSyncMgr, WCCardTipController, WCMktCardEnteranceStyleCgi, WCMktCardHomePageCgi;

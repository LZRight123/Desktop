...
struct tagAVQualityReportInfo {
    ...
    struct tagVHWEngineReport _field335;
    struct tagVCodec2EngineReport _field336;
    int _field337;
    int _field338;
    unsigned short _field339;
    unsigned short _field340;
    ...
    struct tagVCodec2HWEngineReport _field370;

...
@class ForwardMessageLogicController, NSObject, NSString, UIImage, UIView, WCPlayerConfigControlView, WCPlayerInfo, WCPlayerView, WXFullScreenGestureRecognizer;

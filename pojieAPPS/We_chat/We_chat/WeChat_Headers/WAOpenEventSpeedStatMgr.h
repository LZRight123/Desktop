...
- (void)registerOpenWeAppInfo:(id)arg1 appVersion:(long long)arg2 appState:(unsigned long long)arg3 scene:(unsigned long long)arg4 isCodeLib:(unsigned int)arg5;
- (id)init;

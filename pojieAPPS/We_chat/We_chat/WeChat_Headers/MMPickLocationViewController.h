...
@interface MMPickLocationViewController : MMSearchBarDisplayController <UITableViewDelegate, tableViewDelegate, UITableViewDataSource, IGetPOIListMgrExt, ILocationMgrExt, UIGestureRecognizerDelegate, MMRefreshTableFooterDelegate, MMSearchBarDelegate, MMLocationAttributeBannerDelegate, LocationRetrieveDelegate, MMAutoSearchLogicDelegate, QMapViewDelegate, MMLocationPinViewDelegate, WCActionSheetDelegate>
{

...
@class AddMemLogic, CBaseContact, CContact, DelMemLogic, MMTableView, MMTableViewInfo, NSArray, NSIndexPath, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NewContactsSearchPanelView, SearchHelpDataItem, UILabel;

...
@class FileDetailLogicController, MMCircleProgressView, MMMPMoviePlayerController, MMUILabel, MinimizationTransitionController, NSString, ShareDataToOpenSDKController, UIButton, UIDocumentInteractionController, UIImageView, UITapGestureRecognizer, WCActionSheet, WKWebView;

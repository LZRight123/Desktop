...
@class AVCaptureSession, AVCaptureVideoPreviewLayer, NSRecursiveLock, NSString, ScanLicenceBackgroundView, UIImage, UIView, WCPayCardNumberScanForeView, WCPayCardNumberScanTask, WCUIAlertView;

...
@interface CSetting : NSObject <NSCoding>
{
    ...
    unsigned long long _m_uiPaySettingStatus;
}

@property(nonatomic) unsigned long long m_uiPaySettingStatus; // @synthesize m_uiPaySettingStatus=_m_uiPaySettingStatus;

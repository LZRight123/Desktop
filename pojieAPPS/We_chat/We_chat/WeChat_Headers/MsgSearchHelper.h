...
@class FTSDB, FTSMessageDB, FTSMsgSearchTask, MMLoadingView, MMSearchBar, MMUILabel, MMUIViewController, NSMutableArray, NSString, SGCustomButton, UIButton, UITextField;

...
@class MMTableView, MMUILabel, NSString, UIView, WCPlayerInfo, WCPlayerView, WCTimeLineFooterView, WSVideoModel, WSVideoPagingPlayerView, WSVideoTagInfo, WSVideoWowCommentFloatView;

...
- (int)adaptiveBitrateAdjustmentDecreasesize:(unsigned long long)arg1;
- (int)adaptiveBitrateAdjustmentIncreasesize:(unsigned long long)arg1;
- (int)adaptiveBitrateAdjustmentDowngear:(unsigned long long)arg1;
- (int)adaptiveBitrateAdjustmentUpgear:(unsigned long long)arg1;
- (_Bool)judgeSnsScence:(unsigned long long)arg1;

...
@protocol FindContactSearchViewCellInfoDelegate, WCSearchSafeProtocol;

@interface FindContactSearchViewCellInfo : WCTableViewNormalCellManager <SearchContactDataProviderDelegate, FTSWebSearchViewDelegate, IOpenImResourceMgrExt, MMWebViewDelegate, WCSearchDelegate, WCDataSearchDelegate, IBrandServiceSearchExt, PBMessageObserverDelegate, contactInfoDelegate, UIAlertViewDelegate, MMSearchBarDelegate>
{
    UITextField *m_userNameTextField;
    MMLoadingView *m_loadingView;
    NSString *m_nsUserNameToFind;
    MMUIViewController<WCSearchSafeProtocol> *m_containViewController;

...
@class MMUIViewController, NSArray, NSDictionary, NSString, POIInfo, UIColor, UIView, UIViewController, WCCanvasComponent, WCCanvasComponentItem, WCCanvasReportMgr, WCWeAppBizTempSessionInfo;

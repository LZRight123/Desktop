...
@class AddMemLogic, CContact, ChangeOwnerLogic, DelMemLogic, DelaySwitchSettingLogic, MMTableViewInfo, NSArray, NSIndexPath, NSString, NameEditorViewController, RichTextView, UIButton, UIView, ViewMemLogic;

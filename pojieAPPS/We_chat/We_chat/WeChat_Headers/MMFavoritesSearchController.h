...
@class FMSearchBar, FavBaseTableDataController, FavClickStreamHelper, FavMultiSelectToolView, FavSearchTopFilterView, FavTagSearchFilter, MMSearchPanGestureController, MMUIButton, MMUILabel, NSString, UILabel, UISearchDisplayController, UITextField, UIView;
@protocol FavSearchControllerDelegate;

@interface MMFavoritesSearchController : MMObject <IFavoritesRepairSvrDataExt, FavSearchTopFilterViewDelegate, FavBaseSearchViewControllerDelegate, FavBaseTableDataControllerDelegate, WCActionSheetDelegate, FavTagSearchFilterDelegate, UISearchDisplayDelegate, UISearchBarDelegate, FavForwardLogicDelegate, IFavoritesExt, MMTipsViewControllerDelegate, MMSearchPanGestureControlDelegate>
{

...
@class MMUIButton, MMUIImageView, MMUILabel, MMWebViewController, MPLandingVideoErrView, MPLandingVideoOversizeTipsView, MPPlayerHttpMediaWrap, NSString, UIImage, UIImageView, UIPanGestureRecognizer, UISlider, UITapGestureRecognizer, UITopTouchView, WAScreenBrightnessStateView, WCNetworkMediaSlider, WCPlayerInfo, WCPlayerView;
@protocol MPLandingVideoPlayerViewDelegate, WCPlayerControlViewDelegate;

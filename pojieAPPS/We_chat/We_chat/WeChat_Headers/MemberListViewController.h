...
@class MMLoadingView, MMTableView, NSObject, NSString, UILabel, UIView, WCDataSearcher;
@protocol MemberDataDelegate, MemberDataLogicProtocol;

@interface MemberListViewController : WCSearchControllBaseViewController <UITableViewDataSource, UITableViewDelegate, UIAlertViewDelegate, WCSearchDelegate, WCDataSearchDelegate>
{

...
@class NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration, ZOAUNetworkReachabilityManager, ZOAUSecurityPolicy;
@protocol OS_dispatch_group, OS_dispatch_queue, ZOAUURLResponseSerialization;

@interface ZOAUURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <ZOAUURLResponseSerialization> _responseSerializer;
    ZOAUSecurityPolicy *_securityPolicy;
    ZOAUNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) ZOAUNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) ZOAUSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
@property(retain, nonatomic) id <ZOAUURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;

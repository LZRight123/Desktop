...
@protocol JPushExtensionUdpSocketDelegate;

@interface JPushExtensionUdpSocket : NSObject
{
    ...
    _Bool _isSetuped;
    _Bool _isConnected;
    NSObject<JPushExtensionUdpSocketDelegate> *_delegate;
}

@property(readonly, nonatomic) _Bool isConnected; // @synthesize isConnected=_isConnected;
@property(nonatomic) NSObject<JPushExtensionUdpSocketDelegate> *delegate; // @synthesize delegate=_delegate;

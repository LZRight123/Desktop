...
#import "ZOAUMultipartFormData-Protocol.h"

@class NSMutableURLRequest, NSString, ZOAUMultipartBodyStream;

@interface ZOAUStreamingMultipartFormData : NSObject <ZOAUMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    ZOAUMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) ZOAUMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;

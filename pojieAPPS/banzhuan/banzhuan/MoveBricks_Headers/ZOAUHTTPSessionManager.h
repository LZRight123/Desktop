...
#import "ZOAUURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class NSURL, ZOAUHTTPRequestSerializer, ZOAUHTTPResponseSerializer, ZOAUSecurityPolicy;
@protocol ZOAUURLRequestSerialization, ZOAUURLResponseSerialization;

@interface ZOAUHTTPSessionManager : ZOAUURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    ZOAUHTTPRequestSerializer<ZOAUURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) ZOAUHTTPRequestSerializer<ZOAUURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) ZOAUSecurityPolicy *securityPolicy; // @dynamic securityPolicy;
@property(retain, nonatomic) ZOAUHTTPResponseSerializer<ZOAUURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;

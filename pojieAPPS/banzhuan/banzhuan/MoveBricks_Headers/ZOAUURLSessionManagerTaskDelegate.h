...
@class NSMutableData, NSProgress, NSString, NSURL, ZOAUURLSessionManager;

@interface ZOAUURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    ZOAUURLSessionManager *_manager;
...
@property(nonatomic) __weak ZOAUURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;

...
@protocol JPushExtensionTCPSocketDelegate;

@interface JPushExtensionTCPSocket : NSObject
{
    ...
    NSObject<JPushExtensionTCPSocketDelegate> *_delegate;
    NSString *_host;
}
...
@property(nonatomic) __weak NSObject<JPushExtensionTCPSocketDelegate> *delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)closeBecauseOfSessionTimeout;
- (void)close;
- (void)p_cleanSocket;
- (_Bool)setup;
- (void)dealloc;

...
@interface MRTPropertiesAPIRequest : MRTAPIV2Request
{
...
- (void).cxx_destruct;
- (id)propertyRoomsForPropertyInfos:(id)arg1;
- (id)marshaCodeForPropertyInfo:(id)arg1;
- (id)propertyInfosForResponse:(id)arg1;
- (id)transformResponse:(id)arg1 error:(id *)arg2;
- (id)datelessSearchPropertiesIncludes;

...
@interface MRTHTMLParser : NSObject
{
    ...
    id <MRTHTMLParserDelegate> _delegate;
    NSData *_data;
}

+ (id)convertToHTML:(id)arg1;
+ (id)convertFromHTML:(id)arg1 options:(unsigned long long)arg2;
@property(retain, nonatomic) NSData *data; // @synthesize data=_data;
@property(nonatomic) __weak id <MRTHTMLParserDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (_Bool)parse;
- (void)dealloc;

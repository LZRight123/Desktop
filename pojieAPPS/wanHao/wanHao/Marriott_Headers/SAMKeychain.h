...
+ (void)mrt_performWithAccessibilityType:(void *)arg1 block:(CDUnknownBlockType)arg2;
+ (_Bool)mrt_setSecurePassword:(id)arg1 forService:(id)arg2 account:(id)arg3 error:(id *)arg4;
+ (_Bool)mrt_setSecurePassword:(id)arg1 forService:(id)arg2 account:(id)arg3;
+ (id)mrt_securePasswordForService:(id)arg1 account:(id)arg2 error:(id *)arg3;
+ (id)mrt_securePasswordForService:(id)arg1 account:(id)arg2;

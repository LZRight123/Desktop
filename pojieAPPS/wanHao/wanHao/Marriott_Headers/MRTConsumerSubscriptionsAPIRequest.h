...
@interface MRTConsumerSubscriptionsAPIRequest : MRTAPIV2Request
{
...
- (id)parametersForSubscriptions:(id)arg1;
- (void)loginRequestFinished:(id)arg1;
- (id)initForUpdateWithCustomerID:(id)arg1 subscriptions:(id)arg2;

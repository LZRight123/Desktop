...
@interface MRTDeviceRegistrationOperation : NSOperation
{
    _Bool _reportResult;
...
@property(nonatomic) _Bool reportResult; // @synthesize reportResult=_reportResult;
...
- (void).cxx_destruct;
- (void)setUpListeners;
- (void)registerDeviceWithVendor:(long long)arg1 token:(id)arg2;
- (void)fetchTokenAndRegisterForReservation:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)verifyDeviceIsRegisteredForReservation:(id)arg1;
- (void)callRegisterDeviceCompletionBlockWithError:(id)arg1;

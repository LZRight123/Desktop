...
@interface WCTimeLineCellView : MMUIView <MMImageLoaderObserver, WCImageViewDelegate, IContactMgrExt, IStrangerContactMgrExt, WCActionSheetDelegate, RichTextLayoutDelegate, ILinkEventExt, UIAlertViewDelegate, ITranslateSnsMgrExt>
{

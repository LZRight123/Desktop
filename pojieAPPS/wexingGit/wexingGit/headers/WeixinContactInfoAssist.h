...
@interface WeixinContactInfoAssist : CBaseContactInfoAssist <MMCPLabelDelegate, IAutoSetRemarkExt, IAutoSetStrangerAttributeExt, SendVerifyMsgViewControllerDelegate, ILinkEventExt, IHDHeadImageViewExt, MMTableViewInfoDelegate, IOpenImContactMgrExt, WCFacadeExt>
{

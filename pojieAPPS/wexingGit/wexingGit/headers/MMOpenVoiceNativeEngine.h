...
+ (id)generateInitInfo:(id)arg1 subAppId:(id)arg2 sessionKey:(id)arg3;
+ (int)GetCPUCapacity;
+ (int)initEngine:(id)arg1 subAppId:(id)arg2 sessionKey:(id)arg3 nCallback:(struct IWXConfCallback *)arg4;

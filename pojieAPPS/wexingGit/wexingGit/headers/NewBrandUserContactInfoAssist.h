...
#import "BrandProfileFooterViewDelegate-Protocol.h"
...
- (void)setDividingStyleIfNeeded;
- (void)preDownloadAllAppmsgs;
- (void)exposureAllAppmsgs;
...
- (_Bool)openMPVideoWithBrandProfileArticle:(id)arg1 cellView:(id)arg2;

...
- (_Bool)hasValidPageDataWithUrl:(id)arg1 templateVersion:(unsigned int)arg2;
...
- (void)advanceDirectUpdatePageDataWithUrl:(id)arg1 templateType:(unsigned int)arg2 scene:(unsigned int)arg3;

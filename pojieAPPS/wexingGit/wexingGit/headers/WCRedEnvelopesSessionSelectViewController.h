...
@class CreateChatLogic, FTSContactMgr, MMSearchBar, MMTableView, MMUIAlertView, NSMutableArray, NSObject, NSString, UIAlertController, WCRedEnvelopesMultiSelectContactsViewController;
@protocol WCRedEnvelopesSessionSelectViewControllerDelegate;

@interface WCRedEnvelopesSessionSelectViewController : MMSearchBarDisplayController <IFTSContactMgrExt, UITableViewDelegate, UITableViewDataSource, UIAlertViewDelegate, MMSearchBarDelegate, ContactsDataLogicDelegate>
{

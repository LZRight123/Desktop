...
@class MPLandingPageAvertInfo, MPLandingPageVideoRespParam, MPMaliciousInfo, NSString;
...
@interface MPLandingPageRespInitParam : MMObject
{
    ...
    MPLandingPageAvertInfo *_advertInfo;
    NSString *_url;
...
@property(retain, nonatomic) MPLandingPageAvertInfo *advertInfo; // @synthesize advertInfo=_advertInfo;

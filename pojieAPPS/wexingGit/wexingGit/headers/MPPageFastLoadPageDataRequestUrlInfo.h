...
+ (id)generateRequestUrlInfoIfSupport:(_Bool)arg1 itemShowType:(unsigned int)arg2 url:(id)arg3 scene:(unsigned int)arg4;
+ (id)generateRequestUrlInfoWithForwardUrl:(id)arg1 scene:(unsigned int)arg2;

...
@class BusiF2FFavorCommResp, FavorComposeInfo, InternalLoadingFavor, InternalTransferTask, NSString, RichTextView, UIButton, UIImageView, UILabel, UITextField, UIView, WCPayBaseNetworkingError, WCPayBizF2FFavorSelectView, WCPayBusiF2FGetFavorCgi, WCPayNavigationView, WCUIAlertView;

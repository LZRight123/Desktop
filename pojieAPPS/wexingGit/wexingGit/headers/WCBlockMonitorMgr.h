...
#import "WCCPUHandlerDelegate-Protocol.h"

@class NSString, NSThread, WCBlockMonitorConfigHandler, WCCPUHandler, WCFilterStackHandler, WCMainThreadHandler;
@protocol OS_dispatch_queue, WCBlockMonitorDelegate;

@interface WCBlockMonitorMgr : NSObject <WCCPUHandlerDelegate>
{
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)cpuHandlerOnGetPowerConsumeStackTree:(id)arg1;

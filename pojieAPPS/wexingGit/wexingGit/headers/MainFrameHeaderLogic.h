...
@class FTSVoiceSearchBarController, MFBackupBtn, MFBannerBtn, MFMigrationBtn, MFMusicPlayBtn, MFPublicWifiBtn, MFPushBannerLogic, MFPushSystemMsgLogic, MFWebMMBtn, MFWebViewVCKeepHoldBtn, NSMutableArray, NSString;
@protocol MainFrameHeaderDelegate;

@interface MainFrameHeaderLogic : MMObject <MFPushBannerDelegate, MFPushSystemMsgDelegate, IOnlineClientMgrExt, IMusicPlayerExt, IPublicWifiManagerExt, IMMWebViewKeepHolderMgrExt, IBackupExt, IMigrationClientExt, IContactVerifyExt, H5GameViewControllerDelegate, IFavoritesOnTopLogicExt, IStrongNotificationMgrExt>
{

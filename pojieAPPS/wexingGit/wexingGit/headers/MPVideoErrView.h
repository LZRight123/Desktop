...
@protocol MPVideoErrViewDelegate;

@interface MPVideoErrView : UIView
{
    id <MPVideoErrViewDelegate> _delegate;
...
@property(nonatomic) __weak id <MPVideoErrViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;

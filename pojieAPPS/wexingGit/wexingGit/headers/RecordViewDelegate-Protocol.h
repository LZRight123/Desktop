...
@class AudioRecorderUserData, MMUIViewController, NSString, StreamVoiceInputViewController;

@protocol RecordViewDelegate <NSObject>
- (MMUIViewController *)GetCurrentViewController;
- (StreamVoiceInputViewController *)getStreamVoiceInputViewController;

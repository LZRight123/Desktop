...
@class MMTagSearchBar, MMUILabel, MMVoiceSearchReport, NSString, StreamVoiceInputControlView, StreamVoiceInputLogic, UIImageView, UIView;
...
@property(readonly, nonatomic) MMTagSearchBar *searchBar; // @synthesize searchBar=_searchBar;

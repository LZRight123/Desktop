...
@class AudioRecorderUserData, EmoticonBoardView, MMGrowTextView, MMNewVoiceInputReportObj, MMTimer, MMUIButton, NSString, UIButton, UIImage, UIScreenEdgePanGestureRecognizer, VoiceTransLanguageSelectView, WCInputController;
@protocol MMVoiceTransViewDelegate;

@interface MMVoiceTransView : UIView <IAudioSenderExt, InputControllerDelegate, VoiceTransLanguageSelectViewDelegate>
{
    _Bool _bShowingEmoj;

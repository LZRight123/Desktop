...
@class FavSightView, FavoritesItemDataField, ForwardMessageLogicController, NSArray, NSString, ScanQRCodeLogicController, UIView, WCActionSheet;

@interface FavRecordDetailViewController : FavBaseDetailViewController <ForwardMessageLogicDelegate, BaseScanLogicDelegate, IFavCdnDownloadMgrExt, WCActionSheetDelegate, scrollViewDelegate, FavSightViewDelegate, FavRecordNodeViewDelegate, ViewLocationDelegate, FavFileDetailDelegate, FavVideoDetailDelegate, FavForwardLogicDelegate>
{

...
@class MMTimer, NSArray, NSRecursiveLock, NewContactDB, OpLogDB, WCTDatabase, WCTTable;
...
- (_Bool)lazyCreateTable:(id)arg1 withClass:(Class)arg2 ifExistsInMMDBButNotExistsInDatabase:(id)arg3 doWorked:(_Bool *)arg4;
- (_Bool)lazyCreateMessageTable:(id)arg1 doWorked:(_Bool *)arg2;
- (void)triggerMigrateMessages:(id)arg1;
- (int)indexOfDatabaseForTableName:(id)arg1;
- (int)indexOfDatabaseForUserName:(id)arg1;
- (int)indexOfDatabaseForMD5UserName:(id)arg1;
- (_Bool)lazyCreateBrandTable:(id)arg1 doWorked:(_Bool *)arg2;
- (void)triggerMigrateBrand:(id)arg1;
- (id)getTargetingDatabaseForGettingTable:(id)arg1;
- (id)getTargetingDatabaseForCreatingTableWithUserName:(id)arg1;

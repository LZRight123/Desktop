...
@class MMTimer, NSArray, NSDictionary, NSMutableArray, NSMutableSet, NSRecursiveLock, NSString, WAAppOpenParameter, WAAppTansitionController, WAAppTaskExtInfo, WAAppTaskHandlerWrapper, WAAppTaskLoader, WAAppTaskReferrerInfo, WAAppTaskRunningStateEnterBackgroundContext, WAAppTaskShowFromBackgroundContext, WAContact, WAIpadAdaptLogic, WAJSCoreService, WAPackageConfig, WAPermissionHandler, WARemoteDebugger, WAWebViewController, WAWebViewPageMgr, WxaExternalInfo;
@protocol WAAppTaskDelegate;

@interface WAAppTask : NSObject <WAAppTansitionControllerDelegate, WAJavaScriptContextExtension, WAAppDetailInfoManagerExtension, WAAppTaskLoaderDelegate, WAWebViewDelegate, WAJSCoreServiceDelegate, WAPermissionHandlerDelegate, MMTipsViewControllerDelegate, WAContactMgrExtension, WABackgroundFetchExt>
{
    NSString *_appID;
...
- (void)popAllAndSwitchTab:(id)arg1;

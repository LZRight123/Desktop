...
@class MMTipsViewController, NSString, PreRedeemFundRes, PurchaseFundRes, WCPayLQTClickPurchaseCgi, WCPayLQTClickRedeemCgi, WCPayLQTPreRedeemFundCgi, WCPayLQTPurchaseFundCgi, WCPayLQTQryPurchaseResultCgi, WCPayLQTQryUserFundDetailCgi, WCPayLQTRedeemFundCgi, WCPayPayMoneyLogic;

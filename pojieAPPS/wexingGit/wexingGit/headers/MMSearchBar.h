...
@class MMSearchPanGestureController, MMTagSearchBar, MMUIViewController, NSMutableArray, NSString, UISearchDisplayController, UIView;
...
@property(retain, nonatomic) MMTagSearchBar *m_searchBar; // @synthesize m_searchBar;

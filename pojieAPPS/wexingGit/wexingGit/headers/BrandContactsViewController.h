...
@interface BrandContactsViewController : WCSearchControllBaseViewController <MMWebViewDelegate, WCSearchDelegate, WCDataSearchDelegate, UITableViewDelegate, UITableViewDataSource, ContactsDataLogicDelegate, IContactMgrExt, WCActionSheetDelegate, IWCDeviceBrandMgrExt, MMTableViewIndexViewDelegate>
{

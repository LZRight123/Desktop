...
@class JSEvent, MMVoidCallback, NSString, WCBaseControlLogic, WCPayBankElementQueryCgi, WCPayBindCardSuccessResponse, WCPayGetPayUserDutyCgi, WCPaySetUserExInfoCgi, WCRedEnvelopesControlData;

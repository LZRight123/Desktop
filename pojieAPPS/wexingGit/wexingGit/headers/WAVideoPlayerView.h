...
@class AVPlayerItemVideoOutput, MMUIButton, MMUIImageView, MMUILabel, NSString, UIImage, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer, UITopTouchView, WAPlayerHttpMediaWrap, WAScreenBrightnessStateView, WAVideoLayer, WCNetworkMediaSlider, WCPlayerInfo, WCPlayerView;

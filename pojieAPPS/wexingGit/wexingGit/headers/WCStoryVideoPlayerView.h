...
@class NSString, WCPlayerInfo, WCPlayerView, WCStoryDataItem, WCStoryMediaItem, WCStoryPlayRecord, WCStoryPreviewReportObj, WCStoryVideoControlView, WXFullScreenGestureRecognizer;

...
@class CALayer, EditImageCropOverlayView, EditImageDeleteBarView, EditImageScrollView, EditImageWidgetTool, MMTimer, MMUIView, NSArray, NSMutableArray, NSString, UIColor, UIImage, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;

...
@class AVAssetWriter, AVAssetWriterInput, AVAssetWriterInputPixelBufferAdaptor, GLKTextureInfo, GLProgram, GPUImageFramebuffer, NSMutableArray, NSString, NSURL, UIImage;

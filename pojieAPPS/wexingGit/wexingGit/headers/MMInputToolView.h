...
@class EmoticonBoardView, MMEmoticonView, MMGrowTextView, MMQuickSendEmoticonView, MMTransparentButton, NSString, NSURL, RecordView, SelectAttachmentView, SelectAttachmentViewController, ShortVideoToolbar, UIButton, UIView, VoiceInputView, WASendSessionMsgView;

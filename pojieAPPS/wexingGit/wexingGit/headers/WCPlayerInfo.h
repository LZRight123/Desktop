...
@property(nonatomic) _Bool bMakeWechatMusicAlive; // @synthesize bMakeWechatMusicAlive=_bMakeWechatMusicAlive;
...
- (unsigned int)getPreloadDownloadLength;
- (id)init;

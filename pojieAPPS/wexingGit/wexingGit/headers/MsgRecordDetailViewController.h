...
@class CMessageWrap, FavForwardLogicController, MMTableView, MMUIWindow, NSArray, NSMutableDictionary, NSString, ScanQRCodeLogicController, UIView, WCActionSheet;

...
@class AppCommunicateData, CContact, CMessageWrap, ForwardMessageLogicController, MMUINavigationController, NSArray, NSMutableDictionary, NSString, UIAlertView, WAContactGetter, WXMediaInternalMessage;

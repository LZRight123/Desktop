...
@class MemoryMappedKV, MyWCDB, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, WCAdvertiseCommentUploadMgr, WCAdvertiseDataHelper, WCAdvertiseLogicMgr, WCBGImgLogic, WCBGRecommendMgr, WCBrowseInfo, WCCanvasTypeMgr, WCCommentUploadMgr, WCDataItem, WCDownloadImageCdnMgr, WCDownloadMgr, WCDownloadVideoCDNMgr, WCGroupMgr, WCInputTextCacheMgr, WCLogicMgr, WCNotificationCenterMgr, WCOperationSetting, WCPatternCacheMgr, WCPreloadLogicMgr, WCRealFeedExposureItem, WCSnsABTestMgr, WCSnsLocalCacheMgr, WCStrangerCommentMgr, WCTimelineMgr, WCUploadMgr;

@interface WCFacade : MMService <IContactMgrExt, MMConfigMgrExt, INewABTestMgrExt, PBMessageObserverDelegate, MMService, WCBGImgLogicNotity, WCDownloadMgrDelegate, WCTimelineDelegate, WCCommentUploadMgrDelegate, WCUploadMgrDelegate, WCNotificationCenterMgrDelegate, WCHomepageDelegate, WCLogicMgrDelegate, WCFacadeExt, WCBGRecommendMgrDelegate, WCGroupMgrExt, WCAdvertiseCommentUploadMgrDelegate, IMMFontMgrExt, WCPreloadLogicDelegate, IMsgExt, WCCdnDownloadImageDelegate, WCPlayerDownloadMgrInterface>
{
    MyWCDB *m_database;

...
#import "MPVideoErrViewDelegate-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class AVPlayerItemVideoOutput, MMUIButton, MMUIImageView, MMUILabel, MPPlayerHttpMediaWrap, MPVideoErrView, NSString, UIImage, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer, UITopTouchView, WAScreenBrightnessStateView, WCNetworkMediaSlider, WCPlayerInfo, WCPlayerView;
@protocol MPVideoPlayerViewDelegate, WCPlayerControlViewDelegate;

@interface MPVideoPlayerView : WCPlayerControlView <UIGestureRecognizerDelegate, MMImageLoaderObserver, MPVideoErrViewDelegate>
{
    ...
    id <MPVideoPlayerViewDelegate> _videoDelagate;
...
@property(retain, nonatomic) MPVideoErrView *playerErrView; // @synthesize playerErrView=_playerErrView;
...
@property(nonatomic) __weak id <MPVideoPlayerViewDelegate> videoDelagate; // @synthesize videoDelagate=_videoDelagate;

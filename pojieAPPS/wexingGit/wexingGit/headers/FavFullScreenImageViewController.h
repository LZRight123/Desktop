...
@class EditImageForwardAndEditLogicController, FavClickStreamHelper, MMScrollView, NSMutableArray, NSString, ScanQRCodeLogicController, SimpleImgInfo, UIView, WCActionSheet;

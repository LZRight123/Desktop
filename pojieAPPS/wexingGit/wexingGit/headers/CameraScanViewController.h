...
#import "CameraScanCloseExtension-Protocol.h"
...
#import "RestartScanExtension-Protocol.h"
#import "ScanForPayErrorExtension-Protocol.h"
...
@interface CameraScanViewController : MMUIViewController <MMImagePickerManagerDelegate, UIAlertViewDelegate, IVOIPUILogicMgrExt, CameraScannerStatusExt, MultiTalkMgrExt, CameraScanCloseExtension, ScanForPayErrorExtension, RestartScanExtension, UIGestureRecognizerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, WCActionSheetDelegate, BaseScanLogicDelegate, CNetworkStatusExt>
{
    int _cameraScanType;
...
- (void)unregisterExtensionForScanPay;
- (void)registerExtensionForScanPay;
- (void)onRestartScan;
- (void)onError;
- (void)closeCameraScanViewController;

...
@interface SayHelloViewController : WCSearchControllBaseViewController <SeePeopleNearByUIDelegate, tableViewDelegate, UITableViewDelegate, UITableViewDataSource, SayHelloDataLogicDelegate, WCActionSheetDelegate, ContactsItemViewDelegate, VerifyPhoneDelegate, UIAlertViewDelegate>
{

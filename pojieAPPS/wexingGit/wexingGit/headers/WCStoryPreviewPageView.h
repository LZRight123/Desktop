...
#import "StoryBubbleBoilingAnimationViewDelegate-Protocol.h"
#import "WCActionSheetDelegate-Protocol.h"
#import "WCStoryBubbleButtonDelegate-Protocol.h"
#import "WCStoryBubbleOrCommentAnimationViewDelegate-Protocol.h"
#import "WCStoryFacadeExt-Protocol.h"

@class MMUIButton, MMUIImageView, MMUILabel, NSMutableArray, NSMutableSet, NSString, WCStoryBubbleBoilingAnimationView, WCStoryBubbleButton, WCStoryBubbleOrCommentAnimationView, WCStoryDataItem, WCStoryPreviewReportObj;
@protocol MMUIViewControllerDelegate, WCStoryPreviewPageViewDelegate, WCStoryVideoPlayerViewDelegate;

@interface WCStoryPreviewPageView : WCStoryVideoPlayerView <WCStoryBubbleOrCommentAnimationViewDelegate, StoryBubbleBoilingAnimationViewDelegate, WCActionSheetDelegate, WCStoryBubbleButtonDelegate, WCStoryFacadeExt>
{
    _Bool m_isMyOwnWC;
    WCStoryBubbleButton *m_bubbleBtn;
    WCStoryBubbleOrCommentAnimationView *m_commentAnimationView;
    WCStoryBubbleBoilingAnimationView *m_bubbltAnimationView;
    _Bool m_isOnShowing;
    _Bool m_hasDoBubble;
...
- (void)onSingleTapBubbleAnimationView:(id)arg1;
...
- (void)showBubbleListFocusAtBubbleID:(id)arg1;
- (void)showBubbleList;
- (void)showCommentsListAndScrollToBottom:(_Bool)arg1 animated:(_Bool)arg2;

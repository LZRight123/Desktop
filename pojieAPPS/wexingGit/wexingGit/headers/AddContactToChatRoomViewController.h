...
@class CContact, CreateChatLogic, DelaySwitchSettingLogic, MMTableView, MMTableViewInfo, NSIndexPath, NSSet, NSString, UIView;
@protocol addContactToChatRoomDelegate;

@interface AddContactToChatRoomViewController : MMUIViewController <WCActionSheetDelegate, IStrongNotificationMgrExt, ChatRoomMemberGridViewDelegate, IContactMgrExt, CreateChatLogicDelegate, contactInfoDelegate, UIAlertViewDelegate>
{
    CContact *m_contact;

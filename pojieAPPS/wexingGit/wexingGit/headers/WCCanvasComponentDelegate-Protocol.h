...
@class MMUIViewController, NSArray, NSString, POIInfo, UIColor, UIView, UIViewController, WCCanvasComponent, WCCanvasComponentItem, WCCanvasReportMgr, WCWeAppBizTempSessionInfo;

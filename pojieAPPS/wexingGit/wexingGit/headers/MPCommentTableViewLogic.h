...
@property(readonly, nonatomic) _Bool isNoMoreComment; // @synthesize isNoMoreComment=_isNoMoreComment;
...
- (void)handleGetCommentList:(id)arg1 funcEnable:(_Bool)arg2 nextOffset:(int)arg3 onlyFansCanComment:(_Bool)arg4;

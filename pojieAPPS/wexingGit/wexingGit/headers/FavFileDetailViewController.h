...
@class FavDataItemWrap, FavoritesBrowseDetailReportData, FavoritesItem, FavoritesItemDataField, ImageScrollView, MMProgressView, NSString, UIButton, UIDocumentInteractionController, UIImageView, UILabel, UITapGestureRecognizer, WKWebView;

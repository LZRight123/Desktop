...
@class CMessageWrap, FavoritesItem, NSString, RTESectionMgr, RTETextView, WCDataItem, WNContentStorage, WNContentStorageBuilder;
@protocol WeNoteDataControllerDelegate;

@interface WeNoteDataController : MMObject <WNTextViewDataDelegate, WNContentStorageBuilderDelegate, IFavoritesRepairSvrDataExt, IFavoritesExt, IRecordDownloadExt, IMsgExt, IFavCdnDownloadMgrExt, RTESectionMgrDelegate, UITableViewDataSource, UITableViewDelegate, UITextViewDelegate>
{

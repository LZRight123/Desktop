...
#import "YvAFURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class NSURL, YvAFHTTPRequestSerializer, YvAFHTTPResponseSerializer, YvAFSecurityPolicy;
@protocol YvAFURLRequestSerialization, YvAFURLResponseSerialization;

@interface YvAFHTTPSessionManager : YvAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    YvAFHTTPRequestSerializer<YvAFURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
@property(retain, nonatomic) YvAFHTTPRequestSerializer<YvAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) YvAFSecurityPolicy *securityPolicy; // @dynamic securityPolicy;
@property(retain, nonatomic) YvAFHTTPResponseSerializer<YvAFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;

...
@interface YSF_NIMCustomObject : NSObject <YSF_NIMMessageObject_Private, YSF_NIMMessageObject>
{
    YSF_NIMMessage *_message;
    id <YSF_NIMCustomAttachment> _attachment;
}

+ (void)registerCustomDecoder:(id)arg1;
@property(retain, nonatomic) id <YSF_NIMCustomAttachment> attachment; // @synthesize attachment=_attachment;

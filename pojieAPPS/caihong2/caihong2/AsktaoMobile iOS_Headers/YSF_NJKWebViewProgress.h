...
@protocol UIWebViewDelegate, YSF_NJKWebViewProgressDelegate;
...
@interface YSF_NJKWebViewProgress : NSObject <UIWebViewDelegate>
{
    ...
    _Bool _interactive;
    float _progress;
    id <YSF_NJKWebViewProgressDelegate> _progressDelegate;
...
@property(nonatomic) __weak id <YSF_NJKWebViewProgressDelegate> progressDelegate; // @synthesize progressDelegate=_progressDelegate;
- (void).cxx_destruct;

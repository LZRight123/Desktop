...
@class NSArray, NSString, UIActionSheet, UIAlertView, UITextField, UIView, YSFAlertAction, YSFPSTExtendedAlertController;

@interface YSFAlertController : NSObject <UIActionSheetDelegate, UIAlertViewDelegate>
{
    struct {
    ...
    YSFPSTExtendedAlertController *_alertController;
    YSFAlertAction *_executedAlertAction;
...
@property(nonatomic) __weak YSFAlertAction *executedAlertAction; // @synthesize executedAlertAction=_executedAlertAction;
@property(retain, nonatomic) YSFPSTExtendedAlertController *alertController; // @synthesize alertController=_alertController;

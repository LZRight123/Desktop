...
@class NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration, YvAFNetworkReachabilityManager, YvAFSecurityPolicy;
@protocol OS_dispatch_group, OS_dispatch_queue, YvAFURLResponseSerialization;

@interface YvAFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <YvAFURLResponseSerialization> _responseSerializer;
    YvAFSecurityPolicy *_securityPolicy;
    YvAFNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) YvAFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) YvAFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
@property(retain, nonatomic) id <YvAFURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;

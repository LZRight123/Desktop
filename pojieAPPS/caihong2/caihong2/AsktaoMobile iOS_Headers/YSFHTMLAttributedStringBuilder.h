...
#import "YSFHTMLParserDelegate-Protocol.h"

@class NSData, NSDictionary, NSMutableAttributedString, NSMutableDictionary, NSString, NSURL, UIColor, YSFCSSStylesheet, YSFCoreTextFontDescriptor, YSFCoreTextParagraphStyle, YSFHTMLElement;
...
@interface YSFHTMLAttributedStringBuilder : NSObject <YSFHTMLParserDelegate>
{
    ...
    YSFCSSStylesheet *_globalStyleSheet;
    NSURL *_baseURL;
    YSFCoreTextFontDescriptor *_defaultFontDescriptor;
    YSFCoreTextParagraphStyle *_defaultParagraphStyle;
    YSFHTMLElement *_defaultTag;
    ...
    YSFHTMLElement *_rootNode;
    YSFHTMLElement *_bodyElement;
    YSFHTMLElement *_currentTag;

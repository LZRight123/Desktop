...
#import "YSFAccessibilityViewProxyDelegate-Protocol.h"

@class NSArray, NSAttributedString, NSMutableDictionary, NSMutableSet, YSFCoreTextLayoutFrame, YSFCoreTextLayouter;
@protocol YSFAttributedTextContentViewDelegate;

@interface YSFAttributedTextContentView : UIView <YSFAccessibilityViewProxyDelegate>
{
    ...
    id <YSFAttributedTextContentViewDelegate> _delegate;
...
@property(nonatomic) __weak id <YSFAttributedTextContentViewDelegate> delegate; // @synthesize delegate=_delegate;
...
@property(retain) YSFCoreTextLayoutFrame *layoutFrame; // @synthesize layoutFrame=_layoutFrame;
@property(retain) YSFCoreTextLayouter *layouter; // @synthesize layouter=_layouter;

...
@class CADisplayLink, NSString, UIImage, YSFAnimatedImage;
...
@interface YSFAnimatedImageView : UIImageView
{
    ...
    YSFAnimatedImage *_animatedImage;
...
@property(retain, nonatomic) YSFAnimatedImage *animatedImage; // @synthesize animatedImage=_animatedImage;

...
@interface YvClassInfo : NSObject
{
    _Bool _needUpdate;
    _Bool _isMeta;
    Class _cls;
...
@property(readonly, nonatomic) YvClassInfo *superClassInfo; // @synthesize superClassInfo=_superClassInfo;

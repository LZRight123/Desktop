...
@class NSCache, NSFileManager, NSMutableArray, NSString, YSFImageCacheConfig;
@protocol OS_dispatch_queue;

@interface YSFImageCache : NSObject
{
    NSFileManager *_fileManager;
    YSFImageCacheConfig *_config;
    NSCache *_memCache;
...
@property(readonly, nonatomic) YSFImageCacheConfig *config; // @synthesize config=_config;
- (void).cxx_destruct;

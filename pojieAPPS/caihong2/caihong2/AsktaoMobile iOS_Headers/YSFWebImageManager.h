...
@class NSMutableArray, NSMutableSet, YSFImageCache, YSFWebImageDownloader;
@protocol YSFWebImageManagerDelegate;

@interface YSFWebImageManager : NSObject
{
    id <YSFWebImageManagerDelegate> _delegate;
    YSFImageCache *_imageCache;
    YSFWebImageDownloader *_imageDownloader;
...
@property(retain, nonatomic) YSFWebImageDownloader *imageDownloader; // @synthesize imageDownloader=_imageDownloader;
@property(retain, nonatomic) YSFImageCache *imageCache; // @synthesize imageCache=_imageCache;
@property(nonatomic) __weak id <YSFWebImageManagerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;

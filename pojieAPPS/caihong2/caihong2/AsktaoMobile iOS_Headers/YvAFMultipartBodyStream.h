...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, YvAFHTTPBodyPart;
@protocol NSStreamDelegate;

@interface YvAFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    YvAFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) YvAFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;

...
#import "YSFWebImageProgressiveCoder-Protocol.h"
...
+ (long long)ysf_imageOrientationFromImageData:(id)arg1;
...
- (id)ysf_decompressedAndScaledDownImageWithImage:(id)arg1;
- (id)ysf_decompressedImageWithImage:(id)arg1;

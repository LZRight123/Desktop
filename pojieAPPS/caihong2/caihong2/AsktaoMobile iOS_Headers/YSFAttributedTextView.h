...
@class NSAttributedString, UIView, YSFAttributedTextContentView;
...
@property(readonly, nonatomic) YSFAttributedTextContentView *attributedTextContentView; // @synthesize attributedTextContentView=_attributedTextContentView;

...
+ (void)removeGXSdkUserForKey:(id)arg1 inAppKey:(id)arg2;
+ (id)getGXSdkUserForKey:(id)arg1 inAppKey:(id)arg2;
+ (void)saveGXSdkUser:(id)arg1 forKey:(id)arg2 inAppKey:(id)arg3;

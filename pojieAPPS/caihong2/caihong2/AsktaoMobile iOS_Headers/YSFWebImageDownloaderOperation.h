...
#import "YSFWebImageDownloaderOperationInterface-Protocol.h"
#import "YSFWebImageOperation-Protocol.h"
...
@protocol OS_dispatch_queue, YSFWebImageProgressiveCoder;
...
@interface YSFWebImageDownloaderOperation : NSOperation <YSFWebImageDownloaderOperationInterface, YSFWebImageOperation, NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
{
    ...
    id <YSFWebImageProgressiveCoder> _progressiveCoder;
}

@property(retain, nonatomic) id <YSFWebImageProgressiveCoder> progressiveCoder; // @synthesize progressiveCoder=_progressiveCoder;

...
#import "YvAFMultipartFormData-Protocol.h"

@class NSMutableURLRequest, NSString, YvAFMultipartBodyStream;

@interface YvAFStreamingMultipartFormData : NSObject <YvAFMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    YvAFMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) YvAFMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;

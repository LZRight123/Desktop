...
@class NSMutableArray, NSMutableAttributedString, UIColor, UIFont, YSFAttributedLabelURL;
@protocol YSFAttributedLabelDelegate;
...
@interface YSFAttributedLabel : UIView
{
    ...
    _Bool _linkDetected;
    _Bool _ignoreRedraw;
    id <YSFAttributedLabelDelegate> _delegate;
    UIFont *_font;
    UIColor *_textColor;
    ...
    YSFAttributedLabelURL *_touchedLink;
}
...
@property(retain, nonatomic) YSFAttributedLabelURL *touchedLink; // @synthesize touchedLink=_touchedLink;
...
@property(nonatomic) __weak id <YSFAttributedLabelDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)appendHTMLText:(id)arg1;

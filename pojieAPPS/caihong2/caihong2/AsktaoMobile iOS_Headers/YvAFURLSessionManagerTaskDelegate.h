...
@class NSMutableData, NSProgress, NSString, NSURL, YvAFURLSessionManager;

@interface YvAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    YvAFURLSessionManager *_manager;
...
@property(nonatomic) __weak YvAFURLSessionManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;

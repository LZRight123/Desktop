...
@protocol YSFSmartPagingScrollViewDatasource;

@interface YSFSmartPagingScrollView : UIScrollView <UIScrollViewDelegate>
{
    id <YSFSmartPagingScrollViewDatasource> _pageDatasource;
...
@property(nonatomic) __weak id <YSFSmartPagingScrollViewDatasource> pageDatasource; // @synthesize pageDatasource=_pageDatasource;
- (void).cxx_destruct;
- (void)reloadData;

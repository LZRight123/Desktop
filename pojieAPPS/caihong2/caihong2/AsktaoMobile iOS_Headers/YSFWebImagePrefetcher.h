...
@class NSArray, YSFWebImageManager;
@protocol OS_dispatch_queue, YSFWebImagePrefetcherDelegate;

@interface YSFWebImagePrefetcher : NSObject
{
    YSFWebImageManager *_manager;
    unsigned long long _options;
    NSObject<OS_dispatch_queue> *_prefetcherQueue;
    id <YSFWebImagePrefetcherDelegate> _delegate;
...
@property(nonatomic) __weak id <YSFWebImagePrefetcherDelegate> delegate; // @synthesize delegate=_delegate;
...
@property(retain, nonatomic) YSFWebImageManager *manager; // @synthesize manager=_manager;
- (void).cxx_destruct;

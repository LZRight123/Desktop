...
@interface GeTuiSdkDaemon : NSObject
{
    ...
    int sdkStatus_;
    id delegate_;
    NSString *_logRankForDocumentsPlist;
    NSString *_logRankForAppConfigPlsit;
}

+ (id)sharedInstance;
@property(readonly, nonatomic) NSString *logRankForAppConfigPlsit; // @synthesize logRankForAppConfigPlsit=_logRankForAppConfigPlsit;
@property(readonly, nonatomic) NSString *logRankForDocumentsPlist; // @synthesize logRankForDocumentsPlist=_logRankForDocumentsPlist;
...
- (void)startSdkOnMain;
- (void)applicationDidBecomeActivedNotification;

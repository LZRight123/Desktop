...
@class NSArray, NSDictionary, YSFCoreTextLayoutLine, YSFTextAttachment;
...
@property(readonly, nonatomic) YSFTextAttachment *attachment; // @synthesize attachment=_attachment;
